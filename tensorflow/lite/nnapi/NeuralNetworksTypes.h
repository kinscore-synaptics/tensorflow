 ...
 */
#define FOREACH_ANEURALNETWORKS_OP(__macro) \
    __macro(ANEURALNETWORKS_ADD, 0) \
    __macro(ANEURALNETWORKS_AVERAGE_POOL_2D, 1) \
    __macro(ANEURALNETWORKS_CONCATENATION, 2) \
    __macro(ANEURALNETWORKS_CONV_2D, 3) \
    __macro(ANEURALNETWORKS_DEPTHWISE_CONV_2D, 4) \
    __macro(ANEURALNETWORKS_DEPTH_TO_SPACE, 5) \
    __macro(ANEURALNETWORKS_DEQUANTIZE, 6) \
    __macro(ANEURALNETWORKS_EMBEDDING_LOOKUP, 7) \
    __macro(ANEURALNETWORKS_FLOOR, 8) \
    __macro(ANEURALNETWORKS_FULLY_CONNECTED, 9) \
    __macro(ANEURALNETWORKS_HASHTABLE_LOOKUP, 10) \
    __macro(ANEURALNETWORKS_L2_NORMALIZATION, 11) \
    __macro(ANEURALNETWORKS_L2_POOL_2D, 12) \
    __macro(ANEURALNETWORKS_LOCAL_RESPONSE_NORMALIZATION, 13) \
    __macro(ANEURALNETWORKS_LOGISTIC, 14) \
    __macro(ANEURALNETWORKS_LSH_PROJECTION, 15) \
    __macro(ANEURALNETWORKS_LSTM, 16) \
    __macro(ANEURALNETWORKS_MAX_POOL_2D, 17) \
    __macro(ANEURALNETWORKS_MUL, 18) \
    __macro(ANEURALNETWORKS_RELU, 19) \
    __macro(ANEURALNETWORKS_RELU1, 20) \
    __macro(ANEURALNETWORKS_RELU6, 21) \
    __macro(ANEURALNETWORKS_RESHAPE, 22) \
    __macro(ANEURALNETWORKS_RESIZE_BILINEAR, 23) \
    __macro(ANEURALNETWORKS_RNN, 24) \
    __macro(ANEURALNETWORKS_SOFTMAX, 25) \
    __macro(ANEURALNETWORKS_SPACE_TO_DEPTH, 26) \
    __macro(ANEURALNETWORKS_SVDF, 27) \
    __macro(ANEURALNETWORKS_TANH, 28) \
    __macro(ANEURALNETWORKS_BATCH_TO_SPACE_ND, 29) \
    __macro(ANEURALNETWORKS_DIV, 30) \
    __macro(ANEURALNETWORKS_MEAN, 31) \
    __macro(ANEURALNETWORKS_PAD, 32) \
    __macro(ANEURALNETWORKS_SPACE_TO_BATCH_ND, 33) \
    __macro(ANEURALNETWORKS_SQUEEZE, 34) \
    __macro(ANEURALNETWORKS_STRIDED_SLICE, 35) \
    __macro(ANEURALNETWORKS_SUB, 36) \
    __macro(ANEURALNETWORKS_TRANSPOSE, 37) \
    __macro(ANEURALNETWORKS_ABS, 38) \
    __macro(ANEURALNETWORKS_ARGMAX, 39) \
    __macro(ANEURALNETWORKS_ARGMIN, 40) \
    __macro(ANEURALNETWORKS_BIDIRECTIONAL_SEQUENCE_LSTM, 42) \
    __macro(ANEURALNETWORKS_CAST, 45) \
    __macro(ANEURALNETWORKS_EQUAL, 48) \
    __macro(ANEURALNETWORKS_EXP, 49) \
    __macro(ANEURALNETWORKS_EXPAND_DIMS, 50) \
    __macro(ANEURALNETWORKS_GATHER, 51) \
    __macro(ANEURALNETWORKS_GREATER, 53) \
    __macro(ANEURALNETWORKS_GREATER_EQUAL, 54) \
    __macro(ANEURALNETWORKS_LESS, 58) \
    __macro(ANEURALNETWORKS_LESS_EQUAL, 59) \
    __macro(ANEURALNETWORKS_LOG, 60) \
    __macro(ANEURALNETWORKS_LOGICAL_AND, 61) \
    __macro(ANEURALNETWORKS_LOGICAL_NOT, 62) \
    __macro(ANEURALNETWORKS_LOGICAL_OR, 63) \
    __macro(ANEURALNETWORKS_LOG_SOFTMAX, 64) \
    __macro(ANEURALNETWORKS_MAXIMUM, 65) \
    __macro(ANEURALNETWORKS_MINIMUM, 66) \
    __macro(ANEURALNETWORKS_NEG, 67) \
    __macro(ANEURALNETWORKS_NOT_EQUAL, 68) \
    __macro(ANEURALNETWORKS_PAD_V2, 69) \
    __macro(ANEURALNETWORKS_POW, 70) \
    __macro(ANEURALNETWORKS_PRELU, 71) \
    __macro(ANEURALNETWORKS_QUANTIZE, 72) \
    __macro(ANEURALNETWORKS_QUANTIZED_16BIT_LSTM, 73) \
    __macro(ANEURALNETWORKS_REDUCE_ANY, 76) \
    __macro(ANEURALNETWORKS_REDUCE_MAX, 77) \
    __macro(ANEURALNETWORKS_REDUCE_MIN, 78) \
    __macro(ANEURALNETWORKS_REDUCE_PROD, 79) \
    __macro(ANEURALNETWORKS_REDUCE_SUM, 80) \
    __macro(ANEURALNETWORKS_RSQRT, 83) \
    __macro(ANEURALNETWORKS_SELECT, 84) \
    __macro(ANEURALNETWORKS_SIN, 85) \
    __macro(ANEURALNETWORKS_SLICE, 86) \
    __macro(ANEURALNETWORKS_SPLIT, 87) \
    __macro(ANEURALNETWORKS_SQRT, 88) \
    __macro(ANEURALNETWORKS_TILE, 89) \
    __macro(ANEURALNETWORKS_TOPK_V2, 90) \
    __macro(ANEURALNETWORKS_TRANSPOSE_CONV, 91) \
    __macro(ANEURALNETWORKS_UNIDIRECTIONAL_SEQUENCE_LSTM, 92) \
    __macro(ANEURALNETWORKS_UNIDIRECTIONAL_SEQUENCE_RNN, 93) \
    __macro(ANEURALNETWORKS_RESIZE_NEAREST_NEIGHBOR, 94) \
    __macro(ANEURALNETWORKS_QUANTIZED_LSTM, 95) \
    __macro(ANEURALNETWORKS_IF, 96) \
    __macro(ANEURALNETWORKS_WHILE, 97) \
    __macro(ANEURALNETWORKS_ELU, 98) \
    __macro(ANEURALNETWORKS_HARD_SWISH, 99) \
    __macro(ANEURALNETWORKS_FILL, 100) \
    __macro(ANEURALNETWORKS_RANK, 101)

#define ANEURALNETWORKS_OP_ENUM_ITEM(__name, __idx) \
    __name = __idx,
enum {
FOREACH_ANEURALNETWORKS_OP(ANEURALNETWORKS_OP_ENUM_ITEM)
};
#undef ANEURALNETWORKS_OP_ENUM_ITEM
